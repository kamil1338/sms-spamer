 ...
 */
public class EmptyWaitTimeVerificator extends FieldVerificator {

    public EmptyWaitTimeVerificator(ConfigurationModel model, EditText fieldToVerify) {
    ...
    public void verify() {
        if (field.getText().toString().isEmpty()) {
            ...
            model.setWaitTime(TimeUnit.SECONDS.toMillis(Integer.valueOf(field.getText().toString())));//zamiana sekund na milisekundy
        }
    }
}
